                ...
                <tbody>
                    ...
                    <?php else: ?>
                        <?php foreach ($solicitacoes as $solicitacao): ?>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="button" class="btn btn-danger" 
                                                    data-bs-toggle="modal" 
                                                    data-bs-target="#modalDeletarSolicitacao<?php echo $solicitacao['id'] ?>"
                            ...
                            <!-- Modal Confirmar Exclusão Solicitação -->
                            <div class="modal fade" id="modalDeletarSolicitacao<?php echo $solicitacao['id'] ?>" tabindex="-1">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <form method="post" action="<?php echo base_url('admin/excluirSolicitacao') ?>" class="d-inline">
