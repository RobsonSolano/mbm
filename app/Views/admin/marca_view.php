    ...
    <div class="col-12">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><?php echo esc($marca['nome']) ?></li>
            </ol>
        </nav>
    </div>
</div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <div><strong>#<?php echo $marca['id'] ?></strong></div>
                    </div>
                    <div class="col-md-6 mb-3">
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <div class="bg-light p-3 rounded">
                            <?php echo nl2br(esc($marca['descricao'])) ?>
                        </div>
                    </div>
                    <?php endif; ?>
                </div>
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <div>
                        ...
                        <button type="button" class="btn btn-danger"
                                ...
                                data-bs-target="#modalDeletarMarca">
...
<div class="modal fade" id="modalDeletarMarca" tabindex="-1">
